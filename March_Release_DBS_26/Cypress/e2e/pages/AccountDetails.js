...
AccountMobileNumber01(){
  ...
  // cy.wait(2000);
  cy.get(this.locators.mobile_number).type("+675708213");
  cy.wait(2000);
...
AccountMobileNumber02(){
  ...
  cy.contains('+6XXXXXX13').scrollIntoView().should('be.visible');
  cy.get(':nth-child(5) > td > [style="text-wrap-mode: nowrap; position: relative;"] > svg-icon').click({force:true});
   cy.contains('+675708213').scrollIntoView().should('be.visible');
}
